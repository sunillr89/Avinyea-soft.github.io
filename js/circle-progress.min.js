! function(i) {
    ...
    t.prototype = {
        ...
        initFill: function() {
            function t() {
                var t = i("<canvas>")[0];
                t.width = a.size, t.height = a.size, t.getContext("2d").drawImage(e, 0, 0, s, s), a.arcFill = a.ctx.createPattern(t, "no-repeat"), a.drawFrame(a.lastFrameValue)
            }
            var e, a = this,
                n = this.fill,
                r = this.ctx,
            ...
            if ("string" == typeof n && (n = {
                ...
                if (1 == l.length) this.arcFill = l[0];
                    ...
                    for (var o = n.gradientAngle || 0, h = n.gradientDirection || [s / 2 * (1 - Math.cos(o)), s / 2 * (1 + Math.sin(o)), s / 2 * (1 + Math.cos(o)), s / 2 * (1 - Math.sin(o))], c = r.createLinearGradient.apply(r, h), d = 0; d < l.length; d++) {
                        var u = l[d],
                            g = d / (l.length - 1);
        ...
        return this.each(function() {
            ...
            if (r) r.init(s);
                ...
                "string" == typeof l.fill && (l.fill = JSON.parse(l.fill)), "string" == typeof l.animation && (l.animation = JSON.parse(l.animation)), (s = i.extend(l, s)).el = a, r = new t(s), a.data(n, r)
            }
        })
    }
});